...
public class BackEndController {
	...
	public static Usuario obtenerUsuario(String username) {
		...
		//String json="{\"username\":\"as\",\"password\":123,\"confirmPassword\":123}";
		if(!json.isEmpty()) {
	...
	public static Autoridad obtenerAutoridad(String idAutoridad) {
		//String json="{\"idAutoridad\":123,\"nombre\":\"dian\",\"tipoAutoridad\":\"coactivo\",\"usuarios\":[{\"identificacion\":789,\"tipoIdentificacion\":\"NATURAL\",\"nombres\":\"santiago\",\"apellidos\":\"ortega\",\"username\":\"as\"},{\"identificacion\":678,\"tipoIdentificacion\":\"NATURAL\",\"nombres\":\"carlos\",\"apellidos\":\"ruiz\",\"username\":\"cr\"}]}";
