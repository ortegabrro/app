...
public class Config {
	...
	public static final String ORG1_USR_BASE_PATH = "../network_resources/" + "crypto-config" + File.separator
			+ "peerOrganizations" + File.separator + "org1.example.com" + File.separator + "users" + File.separator
			+ "Admin@org1.example.com" + File.separator + "msp";

	public static final String ORG2_USR_BASE_PATH = "../network_resources/" + "crypto-config" + File.separator
			+ "peerOrganizations" + File.separator + "org2.example.com" + File.separator + "users" + File.separator
			+ "Admin@org2.example.com" + File.separator + "msp";
	...
	public static final ChaincodeID ccid = ChaincodeID.newBuilder().setName(Config.CHAINCODE_1_NAME).build();
